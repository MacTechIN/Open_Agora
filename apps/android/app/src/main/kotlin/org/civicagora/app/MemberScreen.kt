    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(
                ...
                Text(
                    "글을 쓰려면 이메일 인증이 필요합니다. 이미 인증하셨더라도 이 기기에서는 한 번 더 해 주세요.",
                    style = MaterialTheme.typography.bodyMedium,
                )
                Text(
                    "시민 ID는 기기 안에서 만들어지고 기기 밖으로 나오지 않습니다. 그래서 기기마다 다른 ID를 갖습니다. 같은 이메일로 다시 인증하면 이 기기가 추가됩니다 — 새로 가입되는 것이 아닙니다. 한 이메일로 최대 5대까지입니다.",
